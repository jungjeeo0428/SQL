...
CREATE TABLE article(id INT, regDate INT, title VARCHAR(100), `body`TEXT)
# article 테이블 조회(*)
SELECT*
FROM article;
...
#where id = 0
INSERT INTO article
SET  id = 3, regDate =NOW(), title = '제목', `BODY` = '내용';
...
ALTER TABLE article CHANGE writer nickname CHAR(100) NOT NULL AFTER title;
